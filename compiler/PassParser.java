// $ANTLR 3.4 Pass.g 2012-04-28 00:55:26
        ...
        try {
            ...
            switch (alt37) {
                case 1 :
                    ...
                    switch (alt32) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: iterator, LT, iblock, container, args
                        ...
                        case 2 :
                            ...
                            // AST REWRITE
                            // elements: iblock, access, container, LT, iterator
                            // token labels: iterator, container
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                        ...
                        case 3 :
                            ...
                            // AST REWRITE
                            // elements: iterator, iblock, array_definition, LT
                        ...
                        case 4 :
                            ...
                            // AST REWRITE
                            // elements: container, iterator, iblock, LT
                            // token labels: iterator, container
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: iblock, else_test, LT, bool
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt42) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: LT, bool, else_test, else_if_body
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
