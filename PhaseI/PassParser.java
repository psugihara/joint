// $ANTLR 3.4 Pass.g 2012-04-28 00:28:18
        ...
        try {
            ...
            switch (alt37) {
                case 1 :
                    ...
                    switch (alt32) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: LT, container, iblock, args, iterator
                        ...
                        case 2 :
                            ...
                            // AST REWRITE
                            // elements: access, container, iterator, iblock, LT
                            // token labels: iterator, container
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                        ...
                        case 3 :
                            ...
                            // AST REWRITE
                            // elements: iterator, LT, array_definition, iblock
                        ...
                        case 4 :
                            ...
                            // AST REWRITE
                            // elements: iblock, container, LT, iterator
                            // token labels: iterator, container
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: LT, iblock, bool, else_test
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt42) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: bool, LT, else_test, else_if_body
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
